...
function completeCommand(args) {
	let rctCompletePath = vscode.workspace.getConfiguration('ruby.rctComplete').commandPath;
	args.push('--interpreter');
	args.push(vscode.workspace.getConfiguration('ruby.interpreter').commandPath);
